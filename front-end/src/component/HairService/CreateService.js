                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-8 col-md-8">
                                    <form id="form" style={{ textAlign: "left", color: "black", width: "80%" }}>
                                        <div className="mt-10-thienbd" style={{ 'display': 'flex' }}>
                                            ...
                                            <div className="col-lg-9 col-md-4">
                                                ...
                                                {valid.name && <span className="span-thienbd">{valid.name}</span>}
                                            </div>
                                        </div>
                                        ...
                                        <div className="mt-10-thienbd" style={{ 'display': 'flex' }}>
                                            ...
                                            <div className="col-lg-9 col-md-4">
                                                <input
                                                    ...
                                                    onChange={handleChange}
                                                    id="price" />
                                                {valid.price && <span className="span-thienbd">{valid.price}</span>}
                                            </div>
                                        </div>
                                        ...
                                        <div className="mt-10-thienbd" style={{ 'display': 'flex' }}>
                                            ...
                                            <div className="col-lg-9 col-md-4">
                                                <textarea
                                                    ...
                                                    onChange={handleChange}
                                                    id="description" />
                                                {valid.description && <span className="span-thienbd">{valid.description}</span>}
                                            </div>
                                        </div>
                                        ...
                                        <div className="mt-10-thienbd" style={{ display: 'flex' }}>
                                            ...
                                            <div className="col-lg-9 col-md-4">
                                                ...
                                                {valid.type && <span className="span-thienbd">{valid.type}</span>}
                                            </div>
                                        </div>
